...
const sampleLeads: Lead[] = [
  { id: uid(), name: 'Maria Silva', phone: '5511999990001', email: 'maria@email.com', instagram: '@mariasilva', city: 'São Paulo', rg: '', cpf: '', entryDate: '2026-03-01', origin: 'Instagram – direct', interestLevel: 'quente', mainInterest: 'Programa Dançar pra Curar', tags: ['aula assistida'], painPoint: 'Ansiedade', bodyTensionArea: 'Quadril', emotionalGoal: 'Leveza', pipelineStage: '3', responsible: 'Francelle', notes: '' },
  { id: uid(), name: 'Juliana Costa', phone: '5521988880002', email: 'juliana@email.com', instagram: '@jucosta', city: 'Rio de Janeiro', rg: '', cpf: '', entryDate: '2026-03-03', origin: 'Aula gratuita', interestLevel: 'morno', mainInterest: 'Comunidade', tags: ['veio do direct'], painPoint: 'Bloqueio emocional', bodyTensionArea: 'Ombros', emotionalGoal: 'Reconexão', pipelineStage: '2', responsible: 'Francelle', notes: '' },
  { id: uid(), name: 'Fernanda Lima', phone: '5531977770003', email: 'fernanda@email.com', instagram: '@ferlima', city: 'Belo Horizonte', rg: '', cpf: '', entryDate: '2026-03-05', origin: 'Landing page', interestLevel: 'frio', mainInterest: 'Imersão presencial', tags: [], painPoint: 'Tensão corporal', bodyTensionArea: 'Costas', emotionalGoal: 'Liberar emoções', pipelineStage: '1', responsible: '', notes: '' },
