...
const sampleLeads: Lead[] = [
  { id: uid(), name: 'Maria Silva', phone: '5511999990001', email: 'maria@email.com', instagram: '@mariasilva', city: 'São Paulo', rg: '', cpf: '', entryDate: '2026-03-01', origin: 'Instagram – direct', interestLevel: 'quente', mainInterest: 'Programa Dançar pra Curar', tags: ['aula assistida'], customData: { pain_point: 'Ansiedade', body_tension_area: 'Quadril', emotional_goal: 'Leveza' }, pipelineStage: '3', responsible: 'Francelle', notes: '' },
  { id: uid(), name: 'Juliana Costa', phone: '5521988880002', email: 'juliana@email.com', instagram: '@jucosta', city: 'Rio de Janeiro', rg: '', cpf: '', entryDate: '2026-03-03', origin: 'Aula gratuita', interestLevel: 'morno', mainInterest: 'Comunidade', tags: ['veio do direct'], customData: { pain_point: 'Bloqueio emocional', body_tension_area: 'Ombros', emotional_goal: 'Reconexão' }, pipelineStage: '2', responsible: 'Francelle', notes: '' },
  { id: uid(), name: 'Fernanda Lima', phone: '5531977770003', email: 'fernanda@email.com', instagram: '@ferlima', city: 'Belo Horizonte', rg: '', cpf: '', entryDate: '2026-03-05', origin: 'Landing page', interestLevel: 'frio', mainInterest: 'Imersão presencial', tags: [], customData: { pain_point: 'Tensão corporal', body_tension_area: 'Costas', emotional_goal: 'Liberar emoções' }, pipelineStage: '1', responsible: '', notes: '' },
  { id: uid(), name: 'Camila Rocha', phone: '5541966660004', email: 'camila@email.com', instagram: '@camilarocha', city: 'Curitiba', rg: '', cpf: '', entryDate: '2026-02-20', origin: 'Indicação', interestLevel: 'quente', mainInterest: 'Mentoria', tags: ['alta prioridade'], customData: { pain_point: 'Desconexão corpo', body_tension_area: 'Quadril', emotional_goal: 'Leveza' }, pipelineStage: '5', responsible: 'Francelle', notes: '' },
  { id: uid(), name: 'Patrícia Santos', phone: '5551955550005', email: 'patricia@email.com', instagram: '@patsantos', city: 'Porto Alegre', rg: '', cpf: '', entryDate: '2026-02-15', origin: 'Evento', interestLevel: 'quente', mainInterest: 'Programa Dançar pra Curar', tags: ['follow-up'], customData: { pain_point: 'Trauma emocional', body_tension_area: 'Ombros', emotional_goal: 'Reconexão' }, pipelineStage: '7', responsible: 'Francelle', notes: '' },
];
