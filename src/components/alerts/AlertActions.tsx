...
import { Dialog, Button, Textarea, Label } from '@/components/ui/ds';
...
export const AlertActions = ({ alert, isOpen, onClose, onResolve }: AlertActionsProps) => {
  ...
  return (
    <Dialog 
      open={isOpen} 
      onClose={onClose}
      title="Resolver Alerta de Churn"
    >
      <div className="space-y-4">
        <div className="bg-neutral-50 p-3 rounded-lg border border-neutral-100">
          ...
          <div className="mt-2 flex gap-2">
            <span className="text-xs bg-error-50 text-error-700 px-2 py-0.5 rounded-full border border-error-100 font-medium">
