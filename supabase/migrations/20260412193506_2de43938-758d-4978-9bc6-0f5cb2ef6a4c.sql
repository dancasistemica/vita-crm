-- 1. Populate 'clients' table from 'leads' where is_client is true
...
-- 2. Populate 'client_products' from 'sales' (using leads that have sales)
...
-- 3. Populate 'client_products' from 'subscriptions'
